...
class BaseDAL(Generic[ModelType]):
    """
    Data Access Layer - CRUD object with default methods to Create, Read, Update, Delete.
    ...
    * `model`: A SQLAlchemy model class
    ...
    def search_query(self, query: Any, search_data: dict[str, Any] | None) -> Any:
        return query

    def ordering(
        self, query: Any, value: str | list[str | list[str]] | None, search_data: dict[str, Any] | None = None
    ) -> Any:
